...
const About = () => {
    ...
    return (
        <Box>
            <Banner/>
            <Wrapper>
                <Typography variant="h3">BLOG'0</Typography>
                <Text variant="h5">I'm a Computer Engineering Student in Nit Kurukshetra. 
                    I've built this blogging platform using MERN Stack and react framework material ui.<br />
